...
| **text** | TEXT | 100 | NO | Текст записи |
| **like_count** | INT |  | 11 | Количество лайков к записи |

-Таблица с информацией о комментариях:

| Название | Тип | Длина | NULL | Описание |
| :------: | :------: | :------: | :------: | :------: |
| **id** | INT  |  | 11 | Идентификатор комментария |
| **text** | TEXT |  | NO | Текст комментария |
| **post_id** | INT |  | 11 | ID записи |
...
| **id** | INT  |  | 11 | Идентификатор комментария |
| **text** | TEXT |  | NO | Текст комментария |
| **comment_id** | INT |  | 11 | ID комментария, к которому относится комментарий |
